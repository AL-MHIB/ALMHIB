...
async def _(event):
    ...
    OUTPUT = (f"♛︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس المهيب @E999GI :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث المهيب انتضر من 5 الى 10 دقائق")
    try:
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**♛︙  📑 يرجى متابع قناه الفارات تجدها هنا : @E999GI")
...
( .ايقاف اسم وقتي )
———————×———————
 ♛︙ يوجد شرح مفصل عن الامر هنا : https://t.me/E999GI/4484
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/E999GI/4483
شرح الأوامر : ( @E999GI ) .
قناه السورس : ( @E999GI ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/E999GI/4704 
قناه السورس : ( @E999GI ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/E999GI/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/E999GI/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/E999GI/4720  ⦒
""")
...
———————×——————— 
الأمر ⦙ ( .المده )
الشرح  : يضهر لك مدة تشغيل بوت المهيب لديك 
———————×———————
الأمر ⦙ ( .تحميل ملف + الرد ع الملف )
الشرح : يحمل ملفات المهيب 
———————×———————
الأمر ⦙ ( .مسح ملف + الرد ع الملف )
الشرح :  يمسح الملف الي حملته  
———————×———————
الأمر ⦙ ( .تحديث )
الشرح :  امر لأعاده التشغيل وتحديث ملفات السورس وتسريع الالمهيب 
———————×———————
الأمر ⦙ ( .اطفاء مؤقت + عدد الثواني )
الشرح : يقوم بأطفاء الالمهيب بعدد الثواني الي ضفتها  عندما تخلص الثواني سيتم اعاده تشغيل الالمهيب 
———————×———————
الأمر ⦙ ( .الاوامر ) 
...
———————×———————
الأمر ⦙ ( .استخدامي )
الشرح :   يضهر لك كمية استخدامك لالمهيب
———————×———————
الأمر ⦙ ( .تاريخ التنصيب )
...
الشرح : اي شخص يعملك تاك او يراسلك او يرد عليك يرد عليه المهيب بكليشة انا حاليا غير موجود ويضع له السبب الي نتة وضعته
———×———
